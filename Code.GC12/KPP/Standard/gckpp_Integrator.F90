MODULE gckpp_Integrator
  ...
  USE gckpp_Parameters, ONLY: NVAR, NFIX, NSPEC, LU_NONZERO_1,LU_NSEL_1
  USE gckpp_Global
  IMPLICIT NONE
  PUBLIC
  SAVE
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         CALL FunTemplate_2(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
...
!~~~> Local variables
   ...
   CALL FunTemplate_2(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_2( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_2, LU_NONZERO_2
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_2( Y, FIX, RCONST, Ydot, LU_NSEL_2 )
   TIME = Told
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_2, LU_NONZERO_2
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_2, LU_IROW_2, LU_ICOL_2
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_2)
!~~~> Output variables
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL FunTemplate_3(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
       END IF ! if istage == 1 elseif ros_NewF(istage)
       !slim: CALL WCOPY(N,Fcn,1,K(ioffset+1),1)
       K(ioffset+1:ioffset+N) = Fcn(1:N)
...
!~~~> Local variables
   ...
   Delta = SQRT(Roundoff)*MAX(DeltaMin,ABS(T))
   CALL FunTemplate_3(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   CALL WAXPY(N,(-ONE),Fcn0,1,dFdT,1)
   CALL WSCAL(N,(ONE/Delta),dFdT,1)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_3( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_3, LU_NONZERO_3
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_3( Y, FIX, RCONST, Ydot, LU_NSEL_3 )
   TIME = Told
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_3, LU_NONZERO_3
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_3, LU_IROW_3, LU_ICOL_3
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_3)
!~~~> Output variables
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL FunTemplate_4(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
       END IF ! if istage == 1 elseif ros_NewF(istage)
       !slim: CALL WCOPY(N,Fcn,1,K(ioffset+1),1)
       K(ioffset+1:ioffset+N) = Fcn(1:N)
...
!~~~> Local variables
   ...
   Delta = SQRT(Roundoff)*MAX(DeltaMin,ABS(T))
   CALL FunTemplate_4(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   CALL WAXPY(N,(-ONE),Fcn0,1,dFdT,1)
   CALL WSCAL(N,(ONE/Delta),dFdT,1)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_4( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_4, LU_NONZERO_4
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_4( Y, FIX, RCONST, Ydot, LU_NSEL_4 )
   TIME = Told
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_4, LU_NONZERO_4
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_4, LU_IROW_4, LU_ICOL_4
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_4)
!~~~> Output variables
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL FunTemplate_5(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
       END IF ! if istage == 1 elseif ros_NewF(istage)
       !slim: CALL WCOPY(N,Fcn,1,K(ioffset+1),1)
       K(ioffset+1:ioffset+N) = Fcn(1:N)
...
!~~~> Local variables
   ...
   Delta = SQRT(Roundoff)*MAX(DeltaMin,ABS(T))
   CALL FunTemplate_5(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   CALL WAXPY(N,(-ONE),Fcn0,1,dFdT,1)
   CALL WSCAL(N,(ONE/Delta),dFdT,1)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_5( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_5, LU_NONZERO_5
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_5( Y, FIX, RCONST, Ydot, LU_NSEL_5 )
   TIME = Told
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_5, LU_NONZERO_5
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_5, LU_IROW_5, LU_ICOL_5
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_5)
!~~~> Output variables
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL FunTemplate_6(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
       END IF ! if istage == 1 elseif ros_NewF(istage)
       !slim: CALL WCOPY(N,Fcn,1,K(ioffset+1),1)
       K(ioffset+1:ioffset+N) = Fcn(1:N)
...
!~~~> Local variables
   ...
   Delta = SQRT(Roundoff)*MAX(DeltaMin,ABS(T))
   CALL FunTemplate_6(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   CALL WAXPY(N,(-ONE),Fcn0,1,dFdT,1)
   CALL WSCAL(N,(ONE/Delta),dFdT,1)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_6( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_6, LU_NONZERO_6
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_6( Y, FIX, RCONST, Ydot, LU_NSEL_6 )
   TIME = Told
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_6, LU_NONZERO_6
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_6, LU_IROW_6, LU_ICOL_6
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_6)
!~~~> Output variables
...
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_7, LU_NONZERO_7
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_7, LU_NONZERO_7
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_7, LU_IROW_7, LU_ICOL_7
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_7)
!~~~> Output variables
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL FunTemplate_8(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
       END IF ! if istage == 1 elseif ros_NewF(istage)
       !slim: CALL WCOPY(N,Fcn,1,K(ioffset+1),1)
       K(ioffset+1:ioffset+N) = Fcn(1:N)
...
!~~~> Local variables
   ...
   Delta = SQRT(Roundoff)*MAX(DeltaMin,ABS(T))
   CALL FunTemplate_8(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   CALL WAXPY(N,(-ONE),Fcn0,1,dFdT,1)
   CALL WSCAL(N,(ONE/Delta),dFdT,1)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_8( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_8, LU_NONZERO_8
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_8( Y, FIX, RCONST, Ydot, LU_NSEL_8 )
   TIME = Told
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_8, LU_NONZERO_8
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_8, LU_IROW_8, LU_ICOL_8
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_8)
!~~~> Output variables
...
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_9, LU_NONZERO_9
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_9, LU_NONZERO_9
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_9, LU_IROW_9, LU_ICOL_9
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_9)
!~~~> Output variables
...
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_10, LU_NONZERO_10
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_10, LU_NONZERO_10
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_10, LU_IROW_10, LU_ICOL_10
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_10)
!~~~> Output variables
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL FunTemplate_11(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
       END IF ! if istage == 1 elseif ros_NewF(istage)
       !slim: CALL WCOPY(N,Fcn,1,K(ioffset+1),1)
       K(ioffset+1:ioffset+N) = Fcn(1:N)
...
!~~~> Local variables
   ...
   Delta = SQRT(Roundoff)*MAX(DeltaMin,ABS(T))
   CALL FunTemplate_11(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   CALL WAXPY(N,(-ONE),Fcn0,1,dFdT,1)
   CALL WSCAL(N,(ONE/Delta),dFdT,1)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_11( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_11, LU_NONZERO_11
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_11( Y, FIX, RCONST, Ydot, LU_NSEL_11 )
   TIME = Told
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_11, LU_NONZERO_11
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_11, LU_IROW_11, LU_ICOL_11
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_11)
!~~~> Output variables
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL FunTemplate_12(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
       END IF ! if istage == 1 elseif ros_NewF(istage)
       !slim: CALL WCOPY(N,Fcn,1,K(ioffset+1),1)
       K(ioffset+1:ioffset+N) = Fcn(1:N)
...
!~~~> Local variables
   ...
   Delta = SQRT(Roundoff)*MAX(DeltaMin,ABS(T))
   CALL FunTemplate_12(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   CALL WAXPY(N,(-ONE),Fcn0,1,dFdT,1)
   CALL WSCAL(N,(ONE/Delta),dFdT,1)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_12( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_12, LU_NONZERO_12
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_12( Y, FIX, RCONST, Ydot, LU_NSEL_12 )
   TIME = Told
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_12, LU_NONZERO_12
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_12, LU_IROW_12, LU_ICOL_12
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_12)
!~~~> Output variables
...
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_13, LU_NONZERO_13
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_13, LU_NONZERO_13
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_13, LU_IROW_13, LU_ICOL_13
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_13)
!~~~> Output variables
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL FunTemplate_14(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
       END IF ! if istage == 1 elseif ros_NewF(istage)
       !slim: CALL WCOPY(N,Fcn,1,K(ioffset+1),1)
       K(ioffset+1:ioffset+N) = Fcn(1:N)
...
!~~~> Local variables
   ...
   Delta = SQRT(Roundoff)*MAX(DeltaMin,ABS(T))
   CALL FunTemplate_14(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   CALL WAXPY(N,(-ONE),Fcn0,1,dFdT,1)
   CALL WSCAL(N,(ONE/Delta),dFdT,1)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_14( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_14, LU_NONZERO_14
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_14( Y, FIX, RCONST, Ydot, LU_NSEL_14 )
   TIME = Told
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gckpp_Parameters, ONLY: LU_NSEL_14, LU_NONZERO_14
 USE gckpp_Global, ONLY: FIX, RCONST, TIME
 USE gckpp_Jacobian, ONLY: Jac_SP_14, LU_IROW_14, LU_ICOL_14
 USE gckpp_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: T, Y(LU_NSEL_14)
!~~~> Output variables

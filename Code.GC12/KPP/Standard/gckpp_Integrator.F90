...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE Rosenbrock_1(N,Y,Tstart,Tend, &
           AbsTol,RelTol,              &
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         CALL FunTemplate_1(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
...
!~~~> Local variables
   ...
   CALL FunTemplate_1(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_1( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_1( Y, FIX, RCONST, Ydot, LU_NSEL_1 )
   TIME = Told
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE JacTemplate_1( T, Y, Jcb )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Local variables
    ...
    TIME = T
#ifdef FULL_ALGEBRA    
    CALL Jac_SP_1(Y, FIX, RCONST, JV, LU_NSEL_1, LU_NONZERO_1)
    DO j=1,LU_NSEL_1
      DO i=1,LU_NSEL_1
         Jcb(i,j) = 0.0_dp
      END DO
    ...
    END DO
#else
    CALL Jac_SP_1( Y, FIX, RCONST, Jcb, LU_NSEL_1, LU_NONZERO_1 )
#endif   
    TIME = Told
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL FunTemplate_15(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
       END IF ! if istage == 1 elseif ros_NewF(istage)
       !slim: CALL WCOPY(N,Fcn,1,K(ioffset+1),1)
       K(ioffset+1:ioffset+N) = Fcn(1:N)
...
!~~~> Local variables
   ...
   Delta = SQRT(Roundoff)*MAX(DeltaMin,ABS(T))
   CALL FunTemplate_15(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   CALL WAXPY(N,(-ONE),Fcn0,1,dFdT,1)
   CALL WSCAL(N,(ONE/Delta),dFdT,1)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_15( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_15( Y, FIX, RCONST, Ydot, LU_NSEL_15 )
   TIME = Told

...
! XX - Vector for output variables
  ...
  XX(5) = (X(5)-JVS(3)*XX(1)-JVS(6)*XX(2)-JVS(8)*XX(3)-JVS(10)*XX(4))/(JVS(13))
  XX(5) = XX(5)
  XX(4) = XX(4)-JVS(12)*XX(5)
  XX(3) = XX(3)-JVS(11)*XX(5)
  XX(2) = XX(2)
  XX(1) = XX(1)
...
SUBROUTINE Update_Jac_Para(LU_NONZERO_new)
  USE gckpp_Parameters
  USE gckpp_JacobianSP
  INTEGER :: LU_NONZERO_new(:)
  INTEGER :: nn
  nn=size(LU_NONZERO_new)
  print *,nn
  !print *, LU_IROW
END SUBROUTINE Update_Jac_Para
